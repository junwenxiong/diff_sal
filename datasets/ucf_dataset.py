...
class UCFDataset(MetaDataset):
    ...
    def __getitem__(self, idx):
        ...
        for i in indices:
            img = Image.open(os.path.join(path_clip, '{}_{}_{:03d}.png'.format(vid_name, vid_index, i))).convert('RGB')
...
if __name__ == '__main__':
    ...
    data_loader = DataLoader(train_data, batch_size=16, num_workers=0)
